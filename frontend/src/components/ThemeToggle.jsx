  ...
  return (
    <label className="inline-flex items-center relative">
      ...
      <svg
        ...
        className="fill-yellow-400 peer-checked:opacity-60 absolute w-4 h-4 left-[10px] hover:fill-yellow-300 transition-colors"
      >
        <path
      ...
      <svg
        ...
        id="Layer_1"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-4 h-4 right-[10px] hover:fill-gray-800 transition-colors"
      >
        <path
