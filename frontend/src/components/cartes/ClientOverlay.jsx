...
const ClientOverlay = ({
  ...
  return (
    ...
    >
      <div className={`relative h-full ${compact ? 'p-3' : 'p-4'} flex flex-col`}>
        <button
          onClick={onClose}
        ...
        <div className={`space-y-3 pr-10 -ml-1 ${compact ? 'text-sm' : 'text-base'}`}>
          <div className="flex items-center space-x-2 w-full">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className={`${compact ? 'w-5 h-5' : 'w-6 h-6'} text-gray-700 flex-shrink-0`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex items-center space-x-2 w-full">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className={`${compact ? 'w-5 h-5' : 'w-6 h-6'} text-gray-800 flex-shrink-0`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex items-center space-x-2 w-full">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className={`${compact ? 'w-6 h-6' : 'w-7 h-7'} text-gray-700 flex-shrink-0`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M3 7h11v8H3z" />
